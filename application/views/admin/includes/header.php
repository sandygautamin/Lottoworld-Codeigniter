    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo base_url(); ?>" class="logo">
          ...
          <span class="logo-mini" style="font-size:14px"><b>Admin</b></span>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li>
              <a href="<?php echo base_url(); ?>admin/lotteries" >
            ...
            <li>
              <a href="<?php echo base_url(); ?>admin/productDrawsList" >
                <i class="fa fa-files-o"></i>
                <span>Product Draws</span>
              </a>
            </li>
            ...
            <li>
              <a href="<?php echo base_url(); ?>admin/paymentList" >
                <i class="fa fa-files-o"></i>
