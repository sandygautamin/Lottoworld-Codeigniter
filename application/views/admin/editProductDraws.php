                            ...
                            <div class="row">
                                <div class="col-md-4">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="ProductId" placeholder="ProductId" name="data[ProductId]" value="<?php echo $Info->ProductId; ?>" disabled>
                                        <input type="hidden" name="data[ProductId]" value="<?php echo $Info->ProductId; ?>">
                                        <input type="hidden" name="data[LotteryTypeId]" value="<?php echo $Info->LotteryTypeId; ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">                                
                                    <div class="form-group">
                            ...
                            <div class="row" style="box-shadow: rgba(67, 71, 85, 0.27) 0px 0px 0.25em, rgba(217, 161, 7, 0.2) 0px 0.25em 1em;margin-top:10px">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control" id="MinLines"  name="data[options][row<?php echo $id++;  ?>][id]" value="<?php echo $inform->id;  ?>" >
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
